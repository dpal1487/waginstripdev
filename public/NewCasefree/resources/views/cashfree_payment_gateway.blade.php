                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customerPhone" placeholder="Customer Phone"  value="{{ old('customerPhone') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customerEmail" placeholder="Customer Email"  value="{{ old('customerEmail') }}">
