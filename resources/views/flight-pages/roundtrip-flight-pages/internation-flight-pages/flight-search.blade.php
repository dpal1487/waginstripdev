                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane container fade" id="round-trip-Details-gal{{ $rowGalkey }}">
                                    ...
                                    <div class="onwfntrespons-11">
                                        ...
                                        <span class="text-right onewflydetbtn text-left {{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['Refundable'] }}">{{ $availability['PricingInfos']['PricingInfo'][0]['FareBreakDowns']['FareBreakDown'][0]['Refundable'] }}</span>
                                    </div>
                ...
                <div class="card airline_hide stops_hide mb-3 {{$inbound_img}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-6 col-sm-6">
                                <div class="row block-in-mb ranjepp justify-content-end">
                                    ...
                                    <div class="col-8 col-md-3 col-sm-3 ok_col">
                    ...
                    <div class="row">
                        <div class="col-sm-6"></div>
                         <div class="col-sm-6">
                            <span data-toggle="collapse" data-target="#round-trip-details{{ $rowkey }}" class="onewflydetbtn float-right">Flight Details <i class="fa fa-regular fa-angle-down"></i></span>
                        </div>
                    </div>
