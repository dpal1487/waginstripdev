...
<div class="container flight_sliderOffers mobileVes1 mt-5 mb-5" style="display:none;">
    ...
    <div id="toDestinationsSlider_1" class="carousel slide mt-3 mb-3" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row p-2">
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/honeymoondestinations">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/honeymoondestinations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/romanticdestinations">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/romanticdestinations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/internationaldestinations">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/internationaldestinations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/beachdestinations">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/beachdestinations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="carousel-item">
                <div class="row p-2">
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/weekendgateways">
                            <div class="card">
                                <img class="card-img-top" src="assets/images/holiday/5.jpg" alt="Card image cap"
                                    style="height:200px;">
                                <div class="card-body">
                                    <h6 class="font-weight-bold">Weekend Getaways</h6>
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/weekendgateways">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/hillstations">
                            <div class="card">
                                <img class="card-img-top" src="assets/images/holiday/6.jpg" alt="Card image cap"
                                    style="height:200px;">
                                <div class="card-body">
                                    <h6 class="font-weight-bold">Hill Stations</h6>
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/hillstations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/adventuredestinations">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/adventuredestinations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-3 p-2">
                        <a href="https://wagnistrip.com/heritagedestinations">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="float-right font-weight-bold text-primary" href="https://wagnistrip.com/heritagedestinations">Explore</a>
                                </div>
                            </div>
                        </a>
                    </div>
